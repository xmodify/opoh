...
class Opd extends Model
{
    ...
    protected $fillable = [
        ...
        'visit_ppfs', 'visit_ppfs_claim','visit_ucs_cr', 'visit_ucs_cr_claim',
        'visit_ucs_herb', 'visit_ucs_herb_claim','visit_ucs_healthmed',
        'visit_healthmed','visit_dent','visit_physic','visit_anc','visit_telehealth',
        'visit_moph_oapp_booking','visit_moph_oapp','visit_operation',
    ...
    protected $casts = [
        ...
        'visit_pay'                     => 'int',
        'visit_ppfs'                    => 'int',
        'visit_ppfs_claim'              => 'int',
        'visit_ucs_cr'                  => 'int',
        'visit_ucs_cr_claim'            => 'int',
        'visit_ucs_herb'                => 'int',
        'visit_ucs_herb_claim'          => 'int',
        ...
        'inc_drug_pay'         => 'float',
        'inc_ppfs'             => 'float',
        'inc_ppfs_claim'       => 'float',
        'inc_ppfs_receive'     => 'float',
        'inc_uccr'             => 'float',
        'inc_uccr_claim'       => 'float',
        'inc_uccr_receive'     => 'float',
        'inc_herb'             => 'float',
        'inc_herb_claim'       => 'float',
        'inc_herb_receive'     => 'float',
    ];
}
